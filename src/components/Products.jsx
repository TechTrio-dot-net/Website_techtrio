    ...
    <div className="min-h-screen bg-white dark:bg-gray-900 text-black dark:text-white flex flex-col items-center py-16 px-6">
        ...
        <div className="flex space-x-2 md:space-x-8 bg-black dark:bg-gray-800 p-4 rounded-full w-max mx-auto">
          {tabs.map((tab) => (
            <button
              ...
              className={`px-4 py-2 whitespace-nowrap rounded-full transition-all text-xs md:text-sm font-medium ${activeTab === tab.id
      ...
      <div className="mt-10 px-4 max-w-6xl w-full flex flex-col items-center">
        ...
        <button
          ...
          className="mt-10 inline-flex items-center gap-2 bg-gradient-to-r from-blue-500 to-green-400 text-white px-6 py-3 rounded-full font-semibold hover:brightness-110 transition-all"
        >
          Explore More
          <ArrowRight size={18} />
        </button>
